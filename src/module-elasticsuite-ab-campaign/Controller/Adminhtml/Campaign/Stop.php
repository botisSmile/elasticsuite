 ...
 * @author   Pierre Le Maguer <pierre.lemaguer@smile.fr>
 */
class Stop extends CampaignController
{
    /**
     * {@inheritdoc}
     */
    public function execute()
    {
        ...
        try {
            $this->campaignManager->stopCampaign($model);
            $this->messageManager->addSuccessMessage(__('You stopped the campaign %1.', $model->getName()));
