...
/**
 * Reopen Campaign controller
 *
 * @category Smile
 * @package  Smile\ElasticsuiteAbCampaign
 * @author   Pierre Le Maguer <pierre.lemaguer@smile.fr>
 */
class Reopen extends CampaignController
{
    /**
     * {@inheritdoc}
     */
    public function execute()
    {
        ...
        try {
            $this->campaignManager->reopenCampaign($model);
            $this->messageManager->addSuccessMessage(__('You reopened the campaign %1.', $model->getName()));
